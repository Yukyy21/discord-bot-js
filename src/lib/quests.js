...
const QUEST_CATALOG = {
  ...
  voice_30m: {
    ...
    reward: 500,
    emoji: 'voice',
    label: 'Nongkrong 30 menit di voice',
  },
  daily_claim: {
    scope: 'daily',
    type: 'daily',
  ...
  spend_2000: {
    ...
    reward: 400,
    emoji: 'shop',
    label: 'Belanja 2.000 coin di /shop',
  },
  streak_1: {
    scope: 'daily',
    type: 'daily_streak',
  ...
  boss_join_1: {
    ...
    reward: 450,
    emoji: 'boss',
    label: 'Ikut menyerang mini boss',
  },
  ...
  chat_100: {
    ...
    reward: 3000,
    emoji: 'chat',
    label: 'Rajin mengobrol 100 pesan',
  },
  voice_3h: {
    scope: 'weekly',
    type: 'voice',
  ...
  spend_15000: {
    ...
    reward: 2500,
    emoji: 'shop',
    label: 'Belanja total 15.000 coin',
  },
  use_epic: {
    scope: 'weekly',
    type: 'use_tier',
  ...
  use_legendary: {
    ...
    reward: 4000,
    emoji: 'xp',
    label: 'Pakai satu item Legendary',
  },
  boss_kill_2: {
    scope: 'weekly',
    type: 'boss_kill',
    ...
    reward: 4500,
    emoji: 'boss',
    label: 'Dapat hadiah dari 2 mini boss',
  },
  ...
  chat_500: {
    ...
    reward: 10000,
    emoji: 'chat',
    label: 'Ngobrol 500 pesan sebulan',
  },
  voice_12h: {
    scope: 'monthly',
    type: 'voice',
    ...
    reward: 12000,
    emoji: 'voice',
    label: 'Nongkrong 12 jam sebulan',
  },
  spend_60000: {
    scope: 'monthly',
    type: 'spend',
    ...
    reward: 9000,
    emoji: 'shop',
    label: 'Belanja total 60.000 coin sebulan',
  },
  level_8: {
    scope: 'monthly',
    type: 'level_up',
  ...
  streak_14: {
    ...
    reward: 8000,
    emoji: 'streak',
    label: 'Capai streak daily 14 hari',
  },
};
