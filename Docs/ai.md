...
- Boss diundi otomatis tiap **00:00** dan **12:00** waktu lokal event lalu
  dikirim ke channel mini boss. Admin bisa memaksa lewat `/admin-spawn-boss`.
...
- Hadiah dibagi ke **top 3 damager** (40% / 25% / 15%) dan **pemberi last hit**
  (20%): coin, XP, poin, plus peluang item dari loot table.
