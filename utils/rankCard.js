...
async function buildRankCard({ avatar, username, level, rank, xp, xpNeeded, rankName, rankLogo }) {
  ...
  ctx.fillText(username.length > 16 ? username.slice(0, 15) + '…' : username, 150, 65);
